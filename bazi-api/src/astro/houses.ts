...
import { HouseCusp, HouseSystem, ChartInput } from './types';
import { calculateAscendant, calculateMidheaven, calculateSiderealTime } from './ephemeris';
...
// Whole Sign 하우스 계산
export function calculateWholeSignHouses(ascendant: number): HouseCusp[] {
...
export function calculatePlacidusHouses(
  ...
  houses.push(
    ...
    { house: 8, lon: house8 },
    { house: 9, lon: house9 },
    { house: 11, lon: house11 },
    { house: 12, lon: house12 }
  );
